...
execute as @e[tag=convert,type=item,nbt={Item: {id:"minecraft:glass_bottle"}}] at @s run data merge entity @s {Item:{id:"minecraft:potion",tag:{Potion:"minecraft:water"}}}